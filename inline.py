...
DEV_OP = [
    [
        InlineKeyboardButton(text="🥀 ᴏᴡɴᴇʀ 🥀", url=f"https://t.me/Ajanabee_Duniya"),
    ...
    [
        InlineKeyboardButton(text="❄️ sᴏᴜʀᴄᴇ ❄️", callback_data="https://github.com/Krishnauff/krishna-aaruchatbot"),
